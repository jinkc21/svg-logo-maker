...
class Circle extends Shapes {
    render() {
      return  `<circle cx="100" cy="100" r="100" fill='${this.shapeColor}'/><text x="60" y="120" font-size="4em" text-anchor="middle" fill="${this.textColor}">${this.logoText}</text>`
    }
}

class Square extends Shapes {
    render() {
       return `<rect width="200" height="200" x="10" y="10" fill="${this.shapeColor}" /><text x="70" y="120" font-size="4em" text-anchor="middle" fill="${this.textColor}">${this.logoText}</text>`
    }
}
